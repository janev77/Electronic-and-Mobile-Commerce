...
public class TemporaryReservation {
    ...
    public TemporaryReservation(String code, LocalDate start_date, LocalDate end_date, Integer numOfGuests, Integer price, Accommodation accommodation, User user) {
        this.code = code;
